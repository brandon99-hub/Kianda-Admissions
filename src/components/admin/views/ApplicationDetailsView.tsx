          ...
          <div className="flex items-center gap-6 relative z-10 w-full md:w-auto">
            ...
            <div>
              <div className="flex items-center gap-4 mb-3">
                ...
                <span className={`px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-md border ${currentAppStatus === 'accepted' ? 'bg-green-50 text-green-600 border-green-100' :
                ...
                <span className={`px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-md border ${app.admissionType === 'New' ? 'bg-purple-50 text-purple-600 border-purple-100' :
